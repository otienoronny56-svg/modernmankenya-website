...
export const HeroSection: React.FC = () => {
  return (
    <section className="relative min-h-[calc(100vh-115px)] bg-brand-navy flex flex-col justify-between overflow-hidden">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 sm:pt-8 lg:pt-8 pb-3 sm:pb-4 flex-1 flex flex-col items-center justify-center text-center">
        ...
        {/* Headline */}
        <h1 className="font-serif text-3xl sm:text-5xl lg:text-6xl font-bold text-white tracking-tight leading-[1.12] max-w-4xl mb-3 sm:mb-4">
        ...
        {/* Sub-headline */}
        <p className="text-sm sm:text-base text-slate-300 max-w-2xl font-light leading-relaxed mb-5 sm:mb-6 px-2 sm:px-0">
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-4 sm:pb-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6 pt-3 sm:pt-4 border-t border-white/10 text-left text-xs text-slate-300">
          <div className="flex items-center space-x-2.5 sm:space-x-3 bg-white/[0.03] sm:bg-transparent p-2 sm:p-0 rounded">
